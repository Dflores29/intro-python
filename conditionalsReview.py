...
if weather == "sunny": 
    print("Wear sunglesses and a hat.")
...
# If the input doesn't match any category, inform the user with a message saying the input was not recognized.
    ...
    print("Imput not recognized. Please enter sunny, rainy, or cold")
...
#logical and comparison operation examples 
#>, <, >=, ==, !=, and, or not
...
if age >= 18 and location == "urban":
    print("You are eligibvle to participate.")
else:
